...
// 이미지 변경
var proImgCont = document.querySelector('#proImgCont')
...
function imgAjax(){
    ...
    .then(data => {
        console.log(data)
        proImgCont.innerHTML =
            `<img id="user_profile_img" class="profile_img" src="/res/img/user/${data.loginUser.i_user}/${data.loginUser.profile_img}">\n` +

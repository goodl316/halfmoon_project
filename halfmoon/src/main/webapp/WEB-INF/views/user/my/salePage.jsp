	...
	<div id="seller_info_cont">
		<div id="seller_info_left">
			...
			<div class="seller_product_follow">
				<a class="seller_product_a" href="">상품12</a> <a href="">팔로워12</a>
			</div>
			<div class="seller_follow_talk_btn">
				<button>
					<img alt="" src="/res/img/follow.white.png"> <span>팔로우</span>
				</button>
				<button>
					<span>반월톡</span>
				</button>
		...
		<div>
			<div class="product_ctnt">
				...
				<div class="product_bottom_div">
					<div>0 / 100</div>
					<input type="button" class="product_btn" value="등록" onclick="">
				</div>
			</div>
		</div>
		...
		<div>
			<div class="following_user_cont">
				...
				<div class="following_user_right">
					<div>
						<a href=""> <img alt="" src="/res/img/basic_profile.jpg">
						</a>
					</div>
					<div>
						<a href=""> <img alt="" src="/res/img/basic_profile.jpg">

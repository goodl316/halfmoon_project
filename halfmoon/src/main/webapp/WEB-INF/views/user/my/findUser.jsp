...
<script defer src="/res/js/user/findUser.js?ver=7"></script>
<body>
	...
	<div id="findCont">
		...
		<div id="find_div">
			...
			<button id="findId" onclick="findUser(1)">아이디 찾기</button>
			<span class="span">|</span>
			<button id="findPw" onclick="findUser(3)">비밀번호 찾기</button>
		</div>
	</div>
	...
	<c:if test="${param.state==1}">
		<div class="find_main_cont">
			<div class="findId_main">
				아이디 찾기 <span class="info_input" style="color: green">01.정보 입력</span>
				<span class="next">></span> <span class="info_check">02.아이디
					확인</span>
			</div>
			<div class="findId_cont1">
				<div class="findId_div">
					...
					<div class="findId_user_ph">
						휴대전화 <input class="UserPh" type="text"
							placeholder="-를 제외한 숫자만 입력해주십시오.">
					</div>
				</div>
	...
	<c:if test="${param.state==2 }">
		<div class="find_main_cont">
			<div class="findId_main">
				...
				<span class="info_check" style="color: green">02.아이디 확인</span>
			</div>
			<div class="findId_cont2">
				...
				<div class="findId_next_btn">
					...
					<button class="findPw_btn" onclick="findUser(3)">비밀번호 찾기</button>
				</div>
			</div>
		</div>
	</c:if>
	...
	<div class="find_main_cont">
		<c:if test="${param.state==3}">
			<div class="findPw_main">
				비밀번호 찾기 <span class="id_input" style="color: green">01.아이디 입력</span>
				<span class="pw_next1">></span> <span class="email_check">02.이메일
					본인 인증</span> <span class="pw_next2">></span> <span class="pw_reset1">03.비밀번호
					재설정</span>
			</div>
		...
		<c:if test="${param.state==4 }">
			<div class="findPw_main">
				비밀번호 찾기 <span class="id_input">01.아이디 입력</span> <span
					class="pw_next1">></span> <span class="email_check"
					style="color: green">02.이메일 본인 인증</span> <span class="pw_next2">></span>
				<span class="pw_reset1">03.비밀번호 재설정</span>
			</div>
			<div class="findPw_cont2">
				<div class="findPw_div">
					...
					<div class="findPw_user_email">
						이메일 <input class="findPw_email" type="text" placeholder="id_email">
		...
		<c:if test="${param.state==5 }">
			<div class="findPw_main">
				비밀번호 찾기 <span class="id_input">01.아이디 입력</span> <span
					class="pw_next1">></span> <span class="email_check">02.이메일
					본인 인증</span> <span class="pw_next2">></span> <span class="pw_reset1"
					style="color: green">03.비밀번호 재설정</span>
			</div>

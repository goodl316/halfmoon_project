...
<div class="find_main_cont">
	<div class="findId_main">
		아이디 찾기
		<span class="info_input">01.정보 입력</span>
		<span class="next">></span>
		<span class="info_check">02.아이디 확인</span>
	</div>
	<div class="findId_cont1">
		<div class="findId_div">
			<div class="findId_info1">
				회원정보에 등록한 휴대전화로 인증		
			</div>
			<div class="findId_info2">
				회원정보에 등록한 휴대전화 번호와 입력한 휴대전화 번호가 같아야 인증이 가능합니다.
			</div>
			...
			<div class="findId_user_ph">
				휴대전화
				<input type="text" placeholder="-를 제외한 숫자만 입력해주십시오.">
			</div>
		</div>
	...
	<div class="findId_cont2">
		...
		<div class="findId_next_btn">
			<button class="login_btn">로그인하기</button>
...
<div class="find_main_cont">
	<div class="findPw_main">
		비밀번호 찾기
		<span class="id_input">01.아이디 입력</span>
		<span class="pw_next1">></span>
		<span class="email_check">02.이메일 본인 인증</span>
		<span class="pw_next2">></span>
		<span class="pw_reset1">03.비밀번호 재설정</span>
	</div>
	<div class="findPw_cont1">
		<div class="findPw_div">
			<div class="findPw_info1">
				비밀번호를 찾고자 하는 아이디를 입력해 주세요.
			</div>
			<input class="findPw_input" type="text" placeholder="네이버 아이디">
		</div>
	...
	<div class="findPw_cont2">
		<div class="findPw_div">
			<div class="findPw_info2">
				회원정보에 등록한 이메일로 인증
			</div>
			<div class="findPw_info3">
				회원정보에 등록한 이메일주소와 입력한 이메일주소가 같아야 인증 번호를 받을 수 있습니다.
			</div>
			...
			<div class="findPw_user_email">
				이메일
				<input class="findPw_email" type="text" placeholder="gj******hh@naver.com">

...
public class UserController {
	...
	public Map<String, Object> updPw(@RequestBody UserDTO p) {
	...
	@PostMapping("/user/my/findId")
	@ResponseBody
	public Map<String, Object> findUserId(@RequestBody UserDTO dto) {
		Map<String, Object> val = new HashMap<>();
		val.put(Const.KEY_RESULT, service.findId(dto));
		return val;
	}
	
	@PostMapping("/user/my/findPw")
	@ResponseBody
	public Map<String, Object> findUserPw(@RequestBody UserDTO dto) {
		Map<String, Object> val = new HashMap<>();
		val.put(Const.KEY_RESULT, service.findPw(dto));
		return val;
	}
	
	@PostMapping("/user/my/sendCode")
	@ResponseBody
	public Map<String, Object> sendCode(@RequestBody UserDTO dto) {
		Map<String, Object> val = new HashMap<>();
		val.put(Const.KEY_RESULT, service.sendCode(dto));
		return val;
	}
	
	@PostMapping("/user/my/chkCode")
	@ResponseBody
	public Map<String, Object> chkCode(@RequestBody UserDTO dto) {
		Map<String, Object> val = new HashMap<>();
		val.put(Const.KEY_RESULT, service.chkCode(dto));
		return val;
	}
	
	@PostMapping("/user/my/chPw")
	@ResponseBody
	public Map<String, Object> chPw(@RequestBody UserDTO dto) {
		Map<String, Object> val = new HashMap<>();
		val.put(Const.KEY_RESULT, service.updPw(dto));
